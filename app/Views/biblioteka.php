    ...
    <?php
                        ...
                        if($book_data):
                          ...
                          <?php
                            ...
                            <div class="card col-sm-6 col-md-4 col-lg-3 my-3 text-center border border-info">
                            ...
                            <div class="card-body">
                                ...
                                <p data-id="<?php echo $book['id']; ?>" class="card-text hideContent"><?php echo substr($book['book_details'], 0, 50). '...'; ?></p>
                                  <div class="d-flex justify-content-between">
                                    <a href="./naruci?id=<?php echo $book['id'];?>" class="card-link">Naruči</a>
                                    <a href="./detalji?id=<?php echo $book['id'];?>" class="card-link"> Detaljnije</a>
                                  </div>
                                </div>
                            </div>
